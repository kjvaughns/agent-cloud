 ...
 *
 * The four screens are the sale's own path — pipeline, the form, the book, the
 * money — so the hero says the same thing as the video without a word of copy.
 */
const CARDS: { screen: ScreenKey; rotate: number; x: number; y: number; phase: number }[] = [
  { screen: "pipeline", rotate: -2.4, x: -430, y: -150, phase: 0 },
  { screen: "postDeal", rotate: 1.8, x: 150, y: -252, phase: 1.9 },
  { screen: "book", rotate: -1.2, x: -120, y: 168, phase: 3.4 },
  { screen: "finances", rotate: 2.8, x: 470, y: 62, phase: 5.1 },
];
