...
REVOKE ALL ON FUNCTION public.get_org_leaderboard(timestamp with time zone, timestamp with time zone) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_org_leaderboard(timestamp with time zone, timestamp with time zone) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_org_leaderboard(timestamp with time zone, timestamp with time zone) TO service_role;