/**
 * Notification preferences, as a panel.
 *
 * This was a Settings page of its own (`/settings/notifications`). It is a tab
 * of Agency settings now, so the body lives here — free of PageShell and the
 * hero band — and the old route redirects into the tab.
 */
...
export function NotificationsPanel() {
  ...
  if (isLoading || !prefs) {
    return (
      <div className="max-w-2xl flex flex-col gap-[var(--gap)]">
