...
import { adminListAgentCompLevels, adminSetCompLevel, listAllCarriers, listCarrierGridLevels } from "@/lib/admin.functions";
                    ...
                    {(gridLevels as any[]).length > 0 ? (
                      <Select
                        ...
                        onValueChange={(v) => {
                          ...
                          setEditValue({ name: v, pct: found ? String(found.max_pct) : editValue.pct });
                        }}
                      >
