 ...
 *
 * This is what "Licensing" means when you are the person holding the licence:
 * which states you can write in, what expires when, and the NIPR import that
 * fills it in for you. The agency-wide roster is a different screen for a
 * different job — /licensing sends each person to the right one.
 */
...
export function MyLicensesView() {
  const qc = useQueryClient();
