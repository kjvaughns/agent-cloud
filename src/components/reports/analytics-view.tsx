...
/**
 * Everything that answers "how is the agency doing".
 *
 * This used to be two pages — Analytics and Reports — which meant deciding
 * which one held the number you were after before you could go look for it.
 * They are one page now, at /reports, and this is its body.
 */
  ...
  return (
    <PageShell>
      <div className="col">
        <HeroBand
          title="Reports"
          subtitle="How the agency is performing, and the numbers behind it"
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="flex-wrap h-auto gap-1 bg-card border border-border rounded-[var(--radius)] p-1">
            ...
            <TabsTrigger value="reports">Production &amp; export</TabsTrigger>
