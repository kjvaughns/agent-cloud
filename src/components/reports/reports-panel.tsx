...
import { Panel, HeroBand } from "@/components/page-shell";
...
/**
 * Production and commission summaries, and data export.
 *
 * A tab on the Reports page rather than a page of its own — "the numbers" and
 * "the numbers as a spreadsheet" are the same errand.
 */
...
export function ReportsPanel() {
  ...
  return (
    <div className="flex flex-col gap-[var(--gap)]">
      <HeroBand
        title="Production and commission"
        subtitle="Totals for a date range, and the same data as a spreadsheet"
        actions={
