...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Agent Cloud" },
      { name: "description", content: "Life insurance agency management platform — pipeline, contracting, commissions, retention, analytics, and a downline command center." },
      { name: "author", content: "Agent Cloud" },
      { property: "og:title", content: "Agent Cloud" },
      { property: "og:description", content: "Life insurance agency management platform — pipeline, contracting, commissions, retention, analytics, and a downline command center." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@AgentCloud" },
      { name: "twitter:title", content: "Agent Cloud" },
      { name: "twitter:description", content: "Life insurance agency management platform — pipeline, contracting, commissions, retention, analytics, and a downline command center." },
