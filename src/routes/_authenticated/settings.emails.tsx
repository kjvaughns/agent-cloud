...
export const Route = createFileRoute("/_authenticated/settings/emails")({
  ...
  head: () => ({
    meta: [
      { title: "Email activity — Agent Cloud" },
      {
        name: "description",
        content: "Every email Agent Cloud sent for your agency: template, recipient, status and errors.",
      },
      { property: "og:title", content: "Email activity — Agent Cloud" },
      { property: "og:description", content: "Delivery log and template previews for your agency's emails." },
