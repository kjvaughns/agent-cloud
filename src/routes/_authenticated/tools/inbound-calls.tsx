  ...
  return (
    <PageShell className="max-w-3xl">
      <div className="space-y-[var(--gap)]">
        <HeroBand
          title={<span className="flex items-center gap-2"><PhoneIncoming className="h-6 w-6 text-gold-bright" /> Inbound Calls</span>}
          subtitle="Have qualified life insurance prospects call you."
        />
        <Panel>
