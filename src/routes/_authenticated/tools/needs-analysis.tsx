  ...
  return (
    <PageShell>
      <div className="space-y-[var(--gap)]">
        <HeroBand
          title={<span className="flex items-center gap-2"><Calculator className="h-6 w-6 text-gold-bright" /> Life Insurance Needs Analysis</span>}
          subtitle="AI-powered coverage recommendation using the DIME method."
        />

        <div className="grid lg:grid-cols-3 gap-[var(--gap)]">
          <div className="lg:col-span-2 space-y-[var(--gap)]">
            ...
            <Panel title="Monthly Household Expenses">
              <div className="grid sm:grid-cols-2 gap-4">
            ...
            <Panel title="Financial Assets & Debts">
              <div className="grid sm:grid-cols-2 gap-4">
          ...
          <Panel title="Professional Analysis" className="h-fit sticky top-16">
            <div className="space-y-3 text-sm">
              {!result ? (
                ...
                <>
                  ...
                  <div className="rounded-[var(--radius)] border border-border-soft bg-surface-2 p-4 mt-4">
                    <div className="text-[10px] font-semibold uppercase tracking-[0.07em] text-muted-foreground">Total Recommended Coverage</div>
                    <div className="tnum font-display font-bold text-gold-bright text-3xl mt-1.5 leading-none" style={{ fontFamily: "var(--font-display)" }}>{money(result.total_recommended)}</div>
                  ...
                  {result.client_summary && (
                    <div className="rounded-[10px] border border-border-soft bg-surface-2 p-3 text-xs">
