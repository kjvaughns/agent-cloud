...
export const Route = createFileRoute("/_authenticated/agency/automations")({
  ssr: false,
  head: () => ({
    meta: [
      { title: "Automations — Agent Cloud" },
      {
        name: "description",
        content: "See every scheduled Agent Cloud automation run: what ran, when, and what it touched.",
      },
      { property: "og:title", content: "Automations — Agent Cloud" },
      {
        property: "og:description",
        content: "Scheduled automation run log for your agency.",
      },
