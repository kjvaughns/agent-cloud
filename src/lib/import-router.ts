...
> = {
  ...
  writing_numbers: { table: "writing_numbers", scope: "shared", applies: "importContractingRecords" },
  state_licenses: { table: "state_licenses", scope: "own", applies: "bulkUpsertLicenses" },
