    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={lead}>
            Welcome to {siteName}. Verify the address{' '}
            <Link href={`mailto:${recipient}`} style={inlineLink}>
              {recipient}
            </Link>{' '}
            to activate your account and get into your pipeline.
          </Text>
        ...
        <Section style={footer}>
          <Text style={footerText}>
            If you didn't create an Agent Cloud account, you can safely ignore this email.
          </Text>
