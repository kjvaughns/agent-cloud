...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your one-tap sign-in link for {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={lead}>
            Tap the button below to sign in to {siteName}. This link expires in 1 hour and can only be used once.
          </Text>
