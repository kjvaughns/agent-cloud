...
export const ROUTE_INVENTORY: { path: string; label: string; area: string }[] = [
  ...
  { path: "/settings/roles", label: "Roles \u0026 permissions", area: "Settings" },
  { path: "/settings/agency", label: "Agency settings", area: "Settings" },
  { path: "/settings/automations", label: "Automations", area: "Settings" },
  { path: "/settings/emails", label: "Emails", area: "Settings" },
  { path: "/settings/usage", label: "What people use", area: "Settings" },
  { path: "/retention", label: "Retention", area: "Agency" },
  { path: "/intake", label: "Document Intake", area: "Contracting Ops" },
  { path: "/settings/white-label", label: "White Label", area: "Settings" },
  { path: "/settings/support", label: "Support desk", area: "Settings" },
  { path: "/settings/integrations", label: "Integrations", area: "Settings" },
  ...
  { path: "/contracting-ops/licensing", label: "Licensing roster (staff)", area: "Contracting Ops" },
  { path: "/contracting-ops/documents", label: "Documents", area: "Contracting Ops" },
  { path: "/contracting-ops/carriers", label: "Carrier setup", area: "Contracting Ops" },
  ...
  { path: "/ai-assistant", label: "Nova", area: "Nova" },
  ...
  { path: "/licensing", label: "Licensing (entry point)", area: "Contracting" },
